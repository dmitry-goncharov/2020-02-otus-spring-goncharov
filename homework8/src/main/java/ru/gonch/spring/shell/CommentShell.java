...
public class CommentShell {
    ...
    public String addComment(@ShellOption String name,
        ...
        try {
            String id = commentService.save(new Comment(name, comment, bookId));
            return String.format("Comment with id %s has been added", id);
    ...
    public String updateComment(@ShellOption String id,
        ...
        try {
            if (commentService.update(new Comment(id, name, comment, bookId))) {
                return String.format("Comment with id %s has been updated", id);
            } else {
