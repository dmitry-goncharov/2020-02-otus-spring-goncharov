...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests().antMatchers("/comment/add", "/comment/edit", "/actuator/content").hasAnyRole("USER", "EDITOR", "ADMIN")
                .and()
                .authorizeRequests().antMatchers("/actuator/content").hasAnyRole("EDITOR", "ADMIN")
                .and()
                .authorizeRequests().antMatchers("/user/**", "/actuator/metrics", "/actuator/prometheus", "/actuator/logfile", "/actuator/user", "/hystrix/**").hasRole("ADMIN")
                .and()
                .formLogin()
                .and()
                .logout()
