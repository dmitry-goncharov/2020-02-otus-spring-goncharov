...
export default class BookEdit extends PureComponent {
    constructor() {
        super()
        this.genre = 'genre'
        this.author = 'author'
        this.name = 'name'
        this.state = { id: '', genreId: '', authorId: '', name: '', genres: [], authors: [], shouldFetchGenres: true, shouldFetchAuthors: true }
    ...
    fetchBook() {
        fetch(api.book + '/' + this.props.match.params.id)
            ...
            .then((book) => this.setState({ id: book.id, name: book.name }))
